...
// Инлайн-стили для контейнеров заголовков категорий
...
// Инлайн-стили для заголовков категорий
...
// Инлайн-стили для длинного названия "Сказочные существа"
...
const HomePage = () => {
  // Состояния для разных типов товаров
  ...
  return (
    <div className="home-page">
      ...
      {/* Категории - Обновленный код с инлайн-стилями */}
